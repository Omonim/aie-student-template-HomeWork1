...
- Группа: `РРБО-01-24`
- Контакт: `-`
Для преподавателя: Прошу отнестись с понимаем к дефициту данных о студенте. Берегу конфиденциальность имени и данных в инфо-поле и считаю что представленных данных достаточно если вам необходимо понять чья это работа (Схожего ФИО в группе - Нет).
В случае проблемы коммуникации и связи буду решать вопрос иным способ.
